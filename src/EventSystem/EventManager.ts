import { EventSystemListener, StoppableEvent } from '../Type/Definition/index.js';

class EventManager<EventType extends StoppableEvent> {
  private eventListeners: [number, EventSystemListener<EventType>][] = [];

  registerEventListener(eventListener: EventSystemListener<EventType>, priority: number = 0): void {
