...
const mockServer = setupServer(
  http.get('http://mock-api/246f216a-7fee-472c-8009-a31636f403aa/parents', () => {
...
test('GetElementParentsEndpoint should handle bad response error', async () => {
  ...
  await expect(getElementParentsEndpoint.getElementParents('246f216a-7fee-472c-8009-a31636f403aa')).rejects.toThrow(
    ParseError,
  );

  expect(debugLoggerSpy).toHaveBeenCalledExactlyOnceWith(
    'Executing HTTP GET request against URL: http://mock-api/246f216a-7fee-472c-8009-a31636f403aa/parents?page=1&pageSize=25',
  );
