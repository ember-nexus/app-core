...
const mockServer = setupServer(
  http.get('http://mock-api/1ed272d3-d4bf-4092-96a3-5f043356695b/parents', () => {
...
test('GetElementParentsEndpoint should handle no content type response error', async () => {
  ...
  await expect(getElementParentsEndpoint.getElementParents('1ed272d3-d4bf-4092-96a3-5f043356695b')).rejects.toThrow(
    ParseError,
  );

  expect(debugLoggerSpy).toHaveBeenCalledExactlyOnceWith(
    'Executing HTTP GET request against URL: http://mock-api/1ed272d3-d4bf-4092-96a3-5f043356695b/parents?page=1&pageSize=25',
  );
