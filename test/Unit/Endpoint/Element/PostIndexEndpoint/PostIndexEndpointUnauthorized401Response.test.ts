...
test('PostIndexEndpoint should handle unauthorized response error', async () => {
  mockServer.listen();
  ...
  await expect(postIndexEndpoint.postIndex(element)).rejects.toThrow(Response401UnauthorizedError);
