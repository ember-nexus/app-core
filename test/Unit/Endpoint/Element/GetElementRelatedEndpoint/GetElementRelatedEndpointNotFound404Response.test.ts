...
const mockServer = setupServer(
  http.get('http://mock-api/f260b7e6-f228-4787-a6c7-41f0915e7e56/related', () => {
...
test('GetElementRelatedEndpoint should handle bad response error', async () => {
  ...
  await expect(getElementRelatedEndpoint.getElementRelated('f260b7e6-f228-4787-a6c7-41f0915e7e56')).rejects.toThrow(
    Response404NotFoundError,
  );

  expect(debugLoggerSpy).toHaveBeenCalledExactlyOnceWith(
    'Executing HTTP GET request against URL: http://mock-api/f260b7e6-f228-4787-a6c7-41f0915e7e56/related?page=1&pageSize=25',
  );
