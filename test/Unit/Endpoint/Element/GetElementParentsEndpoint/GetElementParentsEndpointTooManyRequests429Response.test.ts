...
const mockServer = setupServer(
  http.get('http://mock-api/7d68afe8-8c1c-40a9-9700-677e1a460623/parents', () => {
...
test('GetElementParentsEndpoint should handle bad response error', async () => {
  ...
  await expect(getElementParentsEndpoint.getElementParents('7d68afe8-8c1c-40a9-9700-677e1a460623')).rejects.toThrow(
    Response429TooManyRequestsError,
  );

  expect(debugLoggerSpy).toHaveBeenCalledExactlyOnceWith(
    'Executing HTTP GET request against URL: http://mock-api/7d68afe8-8c1c-40a9-9700-677e1a460623/parents?page=1&pageSize=25',
  );
